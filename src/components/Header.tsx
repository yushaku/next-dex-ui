  ...
  return (
    <header
      className={cn(
        dynamicHeaderStyle,
        transparentStyle,
        "fixed right-0 left-0 z-50 mx-auto max-w-7xl",
        ...
        <Link href='/'>
          <div className='flex items-center gap-2'>
            <Image
              ...
              height={45}
              loading='lazy'
              className='animate-fade-down border-foreground/10 rounded-full border-2'
            />
            ...
            <ul className='relative flex items-center justify-between'>
              ...
              <li className='ml-auto lg:ml-0'>
                <button
                  ...
                  className='hover:bg-accent/50 rounded-lg p-2 transition-colors duration-200'
