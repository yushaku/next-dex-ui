    ...
    >
      <div className='inset-0 -mt-7 h-full w-full flex-none'>
        <div className='absolute inset-x-0 top-0 flex justify-center'>
          <p className='bg-sidebar relative z-10 flex items-center space-x-2 rounded-full px-4 py-0.5 ring-1 ring-white/10'>
            <span className='text-foreground relative z-20 inline-block py-0.5 text-xs font-bold'>
              {title}
            </span>
