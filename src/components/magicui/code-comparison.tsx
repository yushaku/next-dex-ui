  ...
  return (
    <div className='mx-auto w-full max-w-5xl'>
      <div className='group border-border relative w-full overflow-hidden rounded-md border'>
        ...
        <div className='text-primary bg-card absolute top-1/2 left-1/2 hidden h-8 w-8 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-md border text-xs md:flex'>
          VS
        </div>
      </div>
    </div>
